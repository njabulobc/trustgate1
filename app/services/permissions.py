...
ROLE_CAPABILITIES: dict[UserRole, list[str]] = {
    ...
    UserRole.COMPLIANCE_OFFICER: [
        'view_dashboard','view_intake','edit_intake','view_kyc','edit_kyc','view_workbench','view_reports'
    ],
    UserRole.ANALYST: [
        'view_dashboard','view_intake','view_kyc','view_screening','resolve_screening','view_risk','assess_risk','view_workbench','resolve_workbench','view_reports'
    ],
    UserRole.REVIEWER: [
        'view_dashboard','view_screening','view_risk','view_edd','manage_edd','view_monitoring','manage_monitoring','view_workbench','resolve_workbench','view_reports','export_reports'
    ],
    UserRole.AUDITOR: [
